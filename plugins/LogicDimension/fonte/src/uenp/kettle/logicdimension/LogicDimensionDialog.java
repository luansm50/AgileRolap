...
public class LogicDimensionDialog extends BaseStepDialog implements
		StepDialogInterface {

	private static Class<?> PKG = LogicDimensionDialog.class;
	...
	public LogicDimensionDialog(Shell parent, Object in, TransMeta transMeta,
			String sname) {
	...
	public String open() {
		...
		fdlVisibleLevel.top = new FormAttachment(wTypeLevel, margin);
		...
		fdVisibleLevel.top = new FormAttachment(wTypeLevel, margin);
