...
public class LogicDimension extends BaseStep implements StepInterface {

	private LogicDimensionData data;
	private LogicTimeDimensionMeta meta;

	public LogicDimension(StepMeta stepMeta,
