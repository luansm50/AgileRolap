...
public class LogicDimensionDialogProperties extends BaseStepDialog implements StepDialogInterface{
	private static Class<?> PKG = LogicDimensionDialogProperties.class;
	...
	public LogicDimensionDialogProperties(Shell parent,
